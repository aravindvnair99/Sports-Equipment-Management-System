...
$(document).ready(function() {
	...
	function fixGridView() {
		if ($('.grid-view').length > 0) {
			...
			if (previous_height < product_height) {
				$('.grid-view.product .product-content').innerHeight(
					product_height
				);
			}
		}
	...
	function singleProduct() {
		...
		$('#product-carousel').flexslider({
			...
			start: function(slider) {
				...
				slider.find('img').click(function() {
					...
					$('#product-slider a.fullscreen-button').attr(
						'href',
						large
					);
				});
		...
		$('a.fullscreen-button').click(function(e) {
			...
			$('#product-carousel a.fancybox[href="' + target + '"]').trigger(
				'click'
			);
		});
		/* Cloud Zoom */
		...
		elements.click(function(e) {
			...
			$('#quick-view-content .quick-view-container').load(
				...
				function() {
					...
					/* Accordions */
					var productButtons = $(
						'#quick-view-content .product-actions'
					).not('.full-width');
					productButtons
						.find('>span:first-child')
						.addClass('current');
					...
					$('#quick-view-modal #product-carousel').flexslider({
						...
						start: function(slider) {
							...
							function setActive(el) {
								var element = el;
								$('#product-carousel img').removeClass(
									'active-item'
								);
								element.addClass('active-item');
							}
	...
	$('#contact-form').submit(function(e) {
		...
		if (
			$(this)
				.find('textarea[name="contact-message"]')
				.val() == ''
		) {
			error = true;
		}
