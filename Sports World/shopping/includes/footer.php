...
<div class="contact-info">
    <div class="footer-logo">
        <div class="logo">
            <a href="index.php" style="color:#0A4B75;">
...
<h3>SPORTS WORLD</h3>
     ...
     <div class="module-body m-t-20">
        ...
        <a href="http://facebook.com/transvelo" class='active' style="background: blue;"><i class="icon fa fa-facebook"></i></a>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">sportsworld5@gmail.com</a></span>
                </div>
            </li>
