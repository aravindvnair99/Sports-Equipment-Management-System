var Maps = (function() {
	...
	var runMaps = function() {
		...
		$(document).on('submit', '.edit_marker', function(e) {
			...
			$marker = $('#markers-with-coordinates')
				.find('li')
				.eq(0)
				.find('a');
		...
		GMaps.on('marker_added', map, function(marker) {
			$('#map-ui').append(
				'<tr><td><a href="#" class="pan-to-marker" data-marker-index="' +
					map.markers.indexOf(marker) +
					'">' +
					marker.title +
					'</a></td><td><a href="#" class="pan-to-marker" data-marker-lat="' +
