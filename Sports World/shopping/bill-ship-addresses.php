...
if (strlen($_SESSION['login']) == 0) {
	...
	<head>
		...
		<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.6.2/js/bootstrap-select.min.js">
											...
											<?php
												...
												<form class="register-form" role="form" method="post">
													<div class="form-group">
														...
														<textarea class="form-control unicase-form-control text-input" "name=" shippingaddress" required="required"> value="<?php echo $row['shippingAddress']; ?>"</textarea>
													</div>
													<div class="form-group">
